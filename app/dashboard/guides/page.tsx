  ...
  return (
    <div className="flex gap-6">
      ...
      <div className="w-56 shrink-0">
        <nav className="bg-cream-100 border-2 border-cream-400 p-4 space-y-1 sticky top-8">
          ...
          <div className="bg-cream-100 border-2 border-cream-400 p-6">
            ...
            <div className="space-y-4">
              <div className="border-b border-cream-400 pb-4">
                <h3 className="text-cream-800 text-lg mb-2">What is Stasis?</h3>
              ...
              <div className="border-b border-cream-400 pb-4">
                <h3 className="text-cream-800 text-lg mb-2">How do I get started?</h3>
              ...
              <div className="border-b border-cream-400 pb-4">
                <h3 className="text-cream-800 text-lg mb-2">How long does review take?</h3>
              ...
              <div className="border-b border-cream-400 pb-4">
                <h3 className="text-cream-800 text-lg mb-2">What counts as a shipped project?</h3>
              ...
              <div className="border-b border-cream-400 pb-4">
                <h3 className="text-cream-800 text-lg mb-2">Can I use online tutorials?</h3>
              ...
              <div className="border-b border-cream-400 pb-4">
                <h3 className="text-cream-800 text-lg mb-2">What if my project gets rejected?</h3>
              ...
              <div className="border-b border-cream-400 pb-4">
                <h3 className="text-cream-800 text-lg mb-2">How are badges awarded?</h3>
              ...
              <div className="border-b border-cream-400 pb-4">
                <h3 className="text-cream-800 text-lg mb-2">What is Hackatime?</h3>
              ...
              <div className="pb-4">
                <h3 className="text-cream-800 text-lg mb-2">Where can I get help?</h3>
