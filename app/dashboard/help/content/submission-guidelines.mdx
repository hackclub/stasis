...
Your project's tier determines its bit allocation (1 bit = $1). **You can spend at most 50% of your earned bits on parts** — the other 50% goes toward your qualification total. Keep your BOM within that limit!

- Always get the minimum quantity of your project. We are funding your project to learn not to mass-produce things like merch. On JLCPCB for example, this means only 5 PCBs, or 2 PCBAs.
...
For build submissions you need to make sure you journal the same as during the design phase, except take photos of the project as you build instead of screenshots.

- If you change something such as CAD or firmware, that also needs to be journalled and your repo needs to be updated with new files.
- If your PCB has problems that got fixed with something like jumpers or any other form of PCB debugging, that must also be fixed and updated in the repo.
- You must include a picture of the built project at the top of your README

#### Extra cool stuff!

This isn't required but you can also make a youtube video or reddit post that showcases your project to the rest of the world. They help get the word out that "Hey I built something awesome and you should all check it out".
