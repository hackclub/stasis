                ...
                <tr key={p.id} className="border-b border-cream-300 last:border-b-0 hover:bg-cream-200/50">
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      {p.user.image ? (
                        <img src={p.user.image} alt="" className="w-6 h-6 border border-cream-400" />
                      ) : (
                        <div className="w-6 h-6 bg-cream-200 border border-cream-400 flex items-center justify-center">
