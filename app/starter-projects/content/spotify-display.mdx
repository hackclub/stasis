...
3. Give it a name, write a small description, and add redirect URI "https://spotifyesp32.vercel.app/api/spotify/callback" (without quotes)!
...
sp.pause_playback();        // Calling this method will pause/play the track
sp.skip_to_next();          // skips current track
sp.skip_to_previous();      // goes to previous track
