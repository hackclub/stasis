...
<div className="not-prose bg-orange-500/15 border border-orange-500 p-4 my-6">
<p className="text-orange-400 font-bold text-sm uppercase tracking-wide mb-1">Kit included</p>
<p className="text-cream-300 text-sm leading-relaxed m-0">Blinky Board is a kit project - when your design is approved, we'll ship you a kit with all the components you need (PCB, ICs, LEDs, resistors, capacitors, and more). You don't need to purchase parts yourself.</p>
</div>
...
- [Blinky Board](#blinky-board)
  ...
  - [Creating Your Project on Stasis](#creating-your-project-on-stasis)
...
- [Assigning Footprints in KiCad](#assigning-footprints-in-kicad)
  ...
  - [Submitting Your Stasis Project to Get Funding](#submitting-your-stasis-project-to-get-funding)

## What We Will Build

We will all build this LED chaser which blinks 10 LEDs in a variable speed sequence.

![](/old-cdn/766c5aee15a8c57b1bd57467f3382fc68c0a627c_unnamed.webp)
...
- Get a PCB grant from Hack Club Stasis
...
## Creating Your Project on Stasis

Now, you just need to create your project on Stasis. Stasis not only allows people to share projects, but acts as a gallery of all the projects made.

First, create your Stasis account on [https://stasis.hackclub.com/](https://stasis.hackclub.com/) (⇒ Sign in). In the future, you will be able to log into your account anywhere, anytime to make your project.

![](https://cdn.hackclub.com/019cfdb9-f837-7c38-a419-60d51b89e614/image.png)
...
![](https://cdn.hackclub.com/019cfdb9-6b7e-77c4-8e7e-05750fc6f974/image.png)

IMPORTANT:
Make sure you select the LED Chaser as your starter project. Doing this will bypass the need for a journal in order to ship. For your future Stasis projects, you will need to make an updated guide with what you are making.
...
You will now need to go through and find all of your components. Luckily, we already compiled a list of everything you need to place — all of these are included in the kit we'll ship you:
...
Here is a good point to remind you. If you ever need help, ask in #stasis-support on the Hack Club Slack.
...
NOTE: ALL projects you make for Stasis must have a project photo in your ReadME.
...
## Submitting Your Stasis Project to Get Funding

You are almost done! At this stage you should have:

- A completed board
- A GitHub repo for your board
- A Stasis project for your board
- A price estimate and screenshot for your board

Go back to your Stasis project screen from before. You should edit the project so the banner is your 3D render.
...
Stasis will run some checks. If any are red, you need to fix them. (you may need to upload your project banner)
...
Check out more Stasis projects on [https://stasis.hackclub.com/dashboard/discover](https://stasis.hackclub.com/dashboard/discover)! You can also make any hardware project you want on Stasis, and get up to $400 to make it. For future Stasis projects, you will need to make a journal throughout your development process. Again, if you have any questions, ask in #stasis-support on Slack.
