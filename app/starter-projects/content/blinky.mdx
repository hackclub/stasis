...
<p className="text-cream-300 text-sm leading-relaxed m-0">Blinky Board is a kit project - when your design is approved, we'll ship you a kit with all the components you need (ICs, LEDs, resistors, capacitors, and more). You don't need to purchase parts yourself.</p>
</div>
